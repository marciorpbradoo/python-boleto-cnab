...
from pyboleto.bank.bankofamerica import BoletoBankOfAmerica

from .testutils import BoletoTestCase

class TestBancoBankOfAmerica(BoletoTestCase):
    def setUp(self):
        self.dados = []
        for i in range(3):
...
suite = unittest.TestLoader().loadTestsFromTestCase(TestBancoBankOfAmerica)
